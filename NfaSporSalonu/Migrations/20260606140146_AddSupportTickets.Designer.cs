...
namespace NfaSporSalonu.Migrations
{
    ...
    [Migration("20260606140146_AddSupportTickets")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NfaSporSalonu.Models.AdminActivityLog", b =>
                {
                    b.Property<int>("LogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NfaSporSalonu.Models.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NfaSporSalonu.Models.QRAccessLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("QRAccessLogs", (string)null);
                });
            ...
            modelBuilder.Entity("NfaSporSalonu.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 2,
                            Description = "Antrenör. Üyelere program atayabilir.",
                            RoleName = "Trainer"
                        },
                        new
                        {
                            RoleId = 3,
                            Description = "Standart üye. Spor salonu hizmetlerini kullanır.",
                            RoleName = "Member"
                        });
                });

            modelBuilder.Entity("NfaSporSalonu.Models.SupportTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NfaSporSalonu.Models.AdminActivityLog", b =>
                {
                    b.HasOne("NfaSporSalonu.Models.User", "AdminUser")
                        .WithMany("AdminActivityLogsAsAdmin")
                        .HasForeignKey("AdminUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_AdminActivityLogs_AdminUser");

                    b.HasOne("NfaSporSalonu.Models.User", "TargetUser")
                        .WithMany("AdminActivityLogsAsTarget")
            ...
            modelBuilder.Entity("NfaSporSalonu.Models.User", b =>
                {
                    ...
                    b.Navigation("AdminActivityLogsAsAdmin");

                    b.Navigation("AdminActivityLogsAsTarget");
